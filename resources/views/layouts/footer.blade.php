...
<div class="fixed bottom-4 left-4 btn-switch-theme">
    <button id="btn-sun-theme" class="hidden bg-gray-900 rounded-full p-2 shadow ring ring-gray-700">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-8 text-yellow-500">
    ...
    <button id="btn-moon-theme" class="bg-white rounded-full p-2 shadow ring ring-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-8 text-gray-900">
